...
function BoardItemCover({ cover }: { cover: string | null }) {
  ...
  return (
    <div className="max-h-60 -mx-4 -mt-4 mb-3 overflow-hidden rounded-t-[20px] bg-slate-100 dark:bg-gray-800">
...
export default function BoardItem({ data }: { data: ExtendedTask }) {
  ...
  return (
    <div className="board-item relative">
      ...
      <h2
        onClick={onClick}
        className="space-x-1 whitespace-normal text-sm font-medium text-slate-700 transition-all active:scale-[97%] hover:underline dark:text-slate-200 cursor-pointer">
